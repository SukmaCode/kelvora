        ...
        <table class="w-full border-collapse min-w-[650px]">
            <thead>
                <tr>
                    ...
                    <th class="px-3 sm:px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-400 bg-black/20 border-b border-border">Stock</th>
                    ...
                    <th class="px-3 sm:px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-400 bg-black/20 border-b border-border">Created</th>
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr class="hover:bg-indigo-500/[0.04] [&:last-child>td]:border-b-0">
                            ...
                            <td class="px-3 sm:px-4 py-3 text-sm border-b border-border align-middle"><?= e($product->stock) ?></td>
                            ...
                            <td class="px-3 sm:px-4 py-3 text-sm border-b border-border align-middle whitespace-nowrap"><?= format_date($product->created_at) ?></td>
                            <td class="px-3 sm:px-4 py-3 text-sm border-b border-border align-middle">
